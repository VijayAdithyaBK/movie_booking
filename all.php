...
<body>
	...
	<table class="main">
		...
		foreach($list as $movie)
		{
			...
			if($movie_details[6]!="Filled")
			{
				echo("<tr><td>"."<a href='details.php?tile=$title' >$title</a>"."</td><td>".$language."</td><td>"."<href='book.php?time=$timings>".$timings."</td><td>".$duration."</td><td>".$rating."</td><td>".$status."</td><td>"."<a href='book.php?&tile=".$title."&time=".$timings."' >Book Now</a>"."</td></tr>");
			}
			else
			{
				echo("<tr><td>"."<a href='details.php?tile=$title' >$title</a>"."</td><td>".$language."</td><td>"."<href='book.php?time=$timings>".$timings."</td><td>".$duration."</td><td>".$rating."</td><td>".$status."</td><td>"."Book Now"."</td></tr>");
			}
		}
